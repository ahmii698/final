...
function AdminAboutHero() {
  ...
  const fetchHero = async () => {
    try {
      const response = await fetch(`${API_URL}/about-hero`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = hero ? `${API_URL}/about-hero/${hero.id}` : `${API_URL}/about-hero/1`;
    ...
    <AdminLayout>
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-white">About Hero Section</h1>
          <button
            onClick={() => {
              setEditing(!editing);
              if (!editing && hero) {
          ...
          <div className="bg-gray-900 rounded-xl p-6">
            <div className="mb-6">
              <img 
                ...
                onError={(e) => {
                  e.target.src = 'https://via.placeholder.com/800x400?text=Hero+Image';
                }}
              />
            </div>
          ...
          <form onSubmit={handleSubmit} className="bg-gray-900 rounded-xl p-6 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-2 rounded bg-gray-800 text-white border border-white/10"
                required
                placeholder="e.g., Crafting excellence since 2024"
              />
            </div>
